    ...
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <div className="sticky top-0 z-10 -mx-4 px-4 pt-1.5 pb-0 backdrop-blur-md" style={{ background: 'var(--bg-header)', borderBottom: '1px solid var(--border-light)' }}>
        <div className="flex items-center justify-between">
          <a href="#/" className="text-base font-bold t-text flex items-center gap-1.5 shrink-0">
        ...
        <div className="flex -mx-1 mt-1">
          <a href="#/" className="flex-1 text-center py-1 text-[11px] font-medium t-text-dim hover:t-text-sub transition border-b-2 border-transparent">대시보드</a>
