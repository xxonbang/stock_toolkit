...
export const SECTION_HELP: Record<string, { title: string; desc: string }> = {
  ...
  squeeze: {
    title: "수급 다이버전스",
    desc: "가격은 하락하지만 수급은 유입되는 괴리(다이버전스) 종목을 탐지합니다.\n\n■ 스코어 산정 (최대 99점)\n· 가격 하락 -3% 이상: 기본 15점 (진입 조건)\n· 외국인 순매수: +25점\n· 기관 순매수: +20점\n· RSI 30 미만 (과매도): +20점\n· 거래량 200% 이상 (급증): +20점\n\n■ 표시 조건\n35점 이상 + 2개 이상 팩터 충족 시 표시됩니다.\n\n■ 해석\n· 55+: 강한 괴리 — 외인/기관 동시 유입 + 기술적 과매도\n· 45~54: 보통 괴리 — 수급 유입은 있으나 일부 팩터 미충족\n· 35~44: 약한 괴리 — 최소 조건만 충족, 추가 확인 필요\n\n스코어가 높을수록 '가격 하락 vs 수급 유입'의 괴리가 크며, 반전 가능성을 시사합니다.",
  },
  valuation: {
    title: "밸류에이션 스크리너",
  ...
  premarket: {
    title: "장전 프리마켓",
    desc: "장 시작 전 글로벌 시장 지표를 종합하여 당일 시장 출발 방향을 예측합니다.\n\n[핵심 요인 표시 기준]\n항상 표시: 코스피200 야간선물, S&P500 선물, 나스닥 선물\n조건부 표시:\n· 원유 선물: |등락률| > 2%\n· 금 선물: |등락률| > 1%\n· SOXX(반도체): |등락률| > 1%\n· EWY(한국ETF): |등락률| > 1.5%\n· F&G: < 25(극단적 공포) 또는 > 75(극단적 탐욕)\n· VIX: > 25(변동성 경고)\n\n임계값 미달 항목은 핵심 요인에 표시되지 않습니다.",
  },
  supply_cluster: {
    title: "수급 클러스터",
  ...
  orderbook: {
    title: "호가창 압력",
    desc: "호가창에서 사려는 사람이 많은지, 팔려는 사람이 많은지를 보여줍니다.\n\n매수우위 85% = 전체 호가 물량 중 85%가 매수 주문\n매도우위 30% = 매수 비율이 30%로, 매도가 우세\n\n[데이터 소스]\n장중: WebSocket 실시간 호가 데이터의 시간 평균 (Supabase 집계)\n장 외: KIS API 호가 스냅샷 (Gemini 분석 데이터)\n\n[선정 기준]\n1. 대상: 교차 신호 + 포트폴리오 종목 전체\n2. 매수·매도 비율 편향이 ±5%p 이상인 종목만 추출\n3. 매수우위 상위 10개 + 매도우위 상위 10개 = 최대 20종목 표시\n4. 50:50에 가까운(편향 5%p 미만) 종목은 제외",
  },
  journal: {
    title: "매매 일지",
  ...
  trading_value: {
    title: "거래대금 이상 감지",
    desc: "거래대금 상위 30종목 중 이상 신호가 감지된 종목만 표시합니다. 조건에 해당하는 종목이 없으면 섹션이 숨겨집니다.\n\n■ 감지 조건\n· 자금 급유입: 거래대금 순위가 전일 대비 5단계 이상 상승\n· 자금 유입: 순위 2~4단계 상승\n· 자금 이탈: 순위 2단계 이상 하락\n· 폭증+급등: 거래량 200% 이상 + 등락률 10% 이상\n· 신규진입: 전일에 없던 종목이 거래대금 상위에 새로 등장\n\n■ 활용법\n자금 급유입 + 상승은 기관/외인의 적극 매수 신호일 수 있습니다. 자금 이탈은 관심 감소 또는 차익 실현 구간입니다.",
  },
  paper_trading: {
    title: "모의투자 현황",
