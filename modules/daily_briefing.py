...
반드시 아래 형식을 그대로 따라 작성한다. 다른 형식 변형 일체 금지.

【섹션 헤더 규칙】
- 섹션명은 반드시 "<b>섹션명</b>" 형태로만 감싼다.
- 숫자, 점, 콜론, <i>, 마크다운(**) 사용 금지. 예) "1. <b>글로벌 환경</b>" 금지, "<i><b>글로벌 환경:</b></i>" 금지.
- 섹션 헤더는 자체 줄에 단독 배치하고, 본문은 다음 줄부터 작성한다.
- 섹션명은 다음 5개 중 정확히 그대로 사용: 글로벌 환경, 오늘의 주목 테마, 고확신 종목, 주의 종목, 전략 제안.
...
본문 내부에서는 <b>, <i> 강조만 허용. <font>, 마크다운(**) 사용 금지. 전체 30줄 이내."""
